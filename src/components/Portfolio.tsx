...
const Portfolio: React.FC = () => {
  const portfolioItems = [
    ...
    { id: 5, filter: '팀 프로젝트', image: 'veg.png', icon : 'Boots.png|React.png', title: 'Ugly Us', description: '리뷰 컴포넌트를 개발 및 리뉴얼하여 사용자 맞춤형 경험과 리뷰 서비스를 제공하는 이커머스 웹사이트입니다.', link: 'https://team-project-reactuglyus.vercel.app/'  },
